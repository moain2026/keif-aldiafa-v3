...
export function getLocalContent(service: string, cityKey: string): {
  ...
  // للمدن ذات الأسماء الطويلة (مكة المكرمة/المدينة المنورة) نستخدم الاسم المختصر
  // في الـ meta title فقط — الاسم الكامل يبقى في H1 والمحتوى (إصلاح 5 عناوين >65 حرفاً).
  const cityTitleAr = c.shortAr || c.ar;
  const metaTitle = isMunasabat
    ? `ضيافة مناسبات ${cityTitleAr} — تجهيز فاخر VIP بنفس اليوم`
    : isQahwajiin
    ? `قهوجيين ${cityTitleAr} — حجز سريع وطاقم بزيّ رسمي VIP`
    : `صبابين قهوة ${cityTitleAr} — طاقم سعودي وحجز بنفس اليوم`;
